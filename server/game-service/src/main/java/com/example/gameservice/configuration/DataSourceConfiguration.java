package com.example.gameservice.configuration;
...
@EnableMongoRepositories(basePackages = {
        "com.example.gameservice.repository"
})
...
public class DataSourceConfiguration {
    ...
    public MongoDatabaseFactory mongoDatabaseFactory(MongoClient mongoClient) {
        return new org.springframework.data.mongodb.core.SimpleMongoClientDatabaseFactory(mongoClient, "vou");
    }
